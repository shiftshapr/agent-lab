...
| [SLACK_TOKEN_REFRESH.md](./SLACK_TOKEN_REFRESH.md) | Slack tokens |
| [PAI_MCP_SETUP.md](./PAI_MCP_SETUP.md) | MCP setup |
| [hermes-setup-guide.md](./hermes-setup-guide.md) | Hermes |

**Monuments** (e.g. Bride of Charlie) also keep `projects/monuments/<name>/docs/` — see linked table in AGENT_AND_MONUMENT_DECISIONS.md.
